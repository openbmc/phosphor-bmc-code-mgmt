...
class ApplyTime : public ApplyTimeIntf
{
  public:
    /** @brief Constructs ApplyTime.
     *
     * @param[in] applyTime - The update apply time.
     */
    ApplyTime(RequestedApplyTimes applyTime) : applyTime(applyTime) {}

    RequestedApplyTimes requestedApplyTime() const
    {
        return applyTime;
    }
...
class Activation : public ActivationInherit, public Flash
{
  public:
    ...
    /** @brief Apply time object */
    std::unique_ptr<ApplyTime> applyTime;
