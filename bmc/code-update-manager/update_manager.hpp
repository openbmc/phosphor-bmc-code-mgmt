        ...
        UpdateManager>
{
  ...
  private:
     ...
     */
    static void subscribeToProgressSignal(const std::string& path);
     ...
     * @param[in] path D-Bus path to the software object.
     */
    static void subscribeToActivationSignal(const std::string& path);
     ...
     */
    static void handlePLDMProgress(const std::string& path, int32_t progress);
