                           ...
                           const std::string& hashFunc)
{
    ...
    {
        std::cout << "Failed to find the Data or signature file" << std::endl;
    ...
    if (!publicKeyPtr)
    {
        std::cout << "createPublicKey failed" << std::endl;
    ...
    if (!hashStruct)
    {
        std::cout << "EVP_get_digestbyname failed" << std::endl;
        error("EVP_get_digestbynam: Unknown message digest: {HASH}", "HASH",
              hashFunc);
        elog<InternalFailure>();
    }

    std::cout << "EVP_get_digestbyname success" << std::endl;
    ...
    std::cout << "isMLDSA: " << isMLDSA << std::endl;
    ...
    {
        std::cout << "verifying MLDSA signature" << std::endl;
