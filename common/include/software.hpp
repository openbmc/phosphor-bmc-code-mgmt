...
class Software : private SoftwareActivation
{
  ...
  private:
    ...
    static std::string createObjectPathWithSwid(const std::string& swid);
    ...
    std::unique_ptr<SoftwareUpdate> softwareUpdate = nullptr;
    ...
    std::unique_ptr<SoftwareVersion> softwareVersion = nullptr;
    ...
    std::unique_ptr<SoftwareAssociationDefinitions>
        softwareAssociationDefinitions = nullptr;
