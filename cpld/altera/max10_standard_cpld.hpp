...
enum class Max10ImageType : uint8_t
{
    unknown = 0,
    cfmImage1 = 1,
    cfmImage2 = 2,
...
constexpr int defaultTimeoutCount = 50000;
...
struct Max10Profile
{
    ...
    Max10ImageType imageType = Max10ImageType::cfmImage1; // CFM_IMAGE_1
...
class Max10StandardCPLD
{
  ...
  private:
    ...
    sdbusplus::async::task<bool> waitEraseDone(int timeoutCount = defaultTimeoutCount);
    sdbusplus::async::task<bool> waitWriteDone(int timeoutCount = defaultTimeoutCount);
