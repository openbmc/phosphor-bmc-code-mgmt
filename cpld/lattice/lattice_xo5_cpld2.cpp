...
sdbusplus::async::task<bool> LatticeXO5CPLD2::sendReceive(
...
sdbusplus::async::task<bool> LatticeXO5CPLD2::eraseCfg(uint8_t cfgIdx)
{
...
sdbusplus::async::task<bool> LatticeXO5CPLD2::verifyCfg(const std::vector<uint8_t>& cfgData)
{
    std::vector<uint8_t> emptyResponse = {};
...
sdbusplus::async::task<bool> LatticeXO5CPLD2::prepareUpdate(
...
sdbusplus::async::task<bool> LatticeXO5CPLD2::readCfg(
...
sdbusplus::async::task<bool> LatticeXO5CPLD2::backupHeader()
{
    // read header data (4K)
    ...
    if (std::all_of(header_data.begin(), header_data.end(), [](uint8_t b) { return b == 0xFF; })) {
...
sdbusplus::async::task<bool> LatticeXO5CPLD2::restoreHeader()
{
