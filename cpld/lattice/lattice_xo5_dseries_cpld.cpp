...
{
/* ESFB packet header */
constexpr uint8_t esfbHeader = 0xBC;

/* ESFB command length limits */
constexpr size_t esfbDataMaxSize = 245;
constexpr size_t esfbPackageLen = 128;

/* ESFB Packet fragment flags */
constexpr uint16_t esfbFirstPacket = 0x8000;
constexpr uint16_t esfbLastPacket = 0x4000;
constexpr uint16_t esfbFirstAndLastPacket = 0xC000;
constexpr size_t esfbFirstPacketNum = 1;

/* ESFB Misc settings */
constexpr auto esfbSleepInterval = std::chrono::milliseconds(5);
constexpr size_t esfbRetryCount = 5000;
constexpr size_t packetImageIdSize = 1;
constexpr uint8_t dryRunResultSuccess = 1;

/* ESFB packet layout positions */
constexpr size_t esfbHeaderPos = 0;
constexpr size_t esfbLengthPos = 4;
constexpr size_t esfbReceiveDataPos = 6;
constexpr size_t esfbReceiveStatusPos = 6;
constexpr size_t esfbReceiveLenPos = 7;

/* ESFB fixed packet lengths */
constexpr size_t esfbReadStatusLength = 10;
constexpr size_t esfbReadStableLength = 7;
constexpr size_t esfbWriteCmdLength = 6;
} // namespace
