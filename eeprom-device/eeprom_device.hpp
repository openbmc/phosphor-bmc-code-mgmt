...
#include "version-providers/version_provider.hpp"
...
class EEPROMDevice : public Device
{
  ...
  private:
    ...
    /**
     *  @brief Handles the host state change signal and updates the version.
     */
    void hostStateChangedUpdateVersion(sdbusplus::message_t& msg);
};
