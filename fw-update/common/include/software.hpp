    ...
    sdbusplus::aserver::xyz::openbmc_project::association::Definitions<Software>
{
  public:
    ...
    Software(sdbusplus::async::context& ctx, const char* objPathConfig,
             const std::string& softwareId, bool isDryRun, Device& parent);
    ...
    // In case of dry run, the update to the device is skipped at the last
    // possible stage. This can be used to test parts of the update flow.
    const bool dryRun;
