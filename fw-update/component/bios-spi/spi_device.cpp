...
// NOLINTBEGIN
sdbusplus::async::task<bool> SPIDevice::startUpdateAsync()
// NOLINTEND
{
...
// NOLINTEND
{
    ...
    writeSPIFlashHostOff(image, image_size);
...
void SPIDevice::writeSPIFlashHostOff(const uint8_t* image, size_t image_size)
{
    gpiod::chip chip;
    try
    {
    ...
    writeSPIFlashHostOffGPIOSet(image, image_size);
...
void SPIDevice::writeSPIFlashHostOffGPIOSet(const uint8_t* image,
                                            size_t image_size)
{
    ...
    {
        SPIDevice::writeSPIFlashHostOffGPIOSetDeviceBound(image, image_size);
    }

    SPIDevice::unbindSPIFlash(this->spiDev);
}

void SPIDevice::writeSPIFlashHostOffGPIOSetDeviceBound(const uint8_t* image,
                                                       size_t image_size)
{
    (void)image;
    (void)image_size;
