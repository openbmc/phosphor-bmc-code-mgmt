...
SPIDevice::SPIDevice(
    ...
    spiDev(spiDevName), objPathConfig(objPathConfig), layoutFlat(layoutFlat),
...
// NOLINTEND
{
    ...
    std::shared_ptr<Software> newsw = std::make_shared<Software>(
        parent->io, objPath, objPathConfig.c_str(), newSwId, dryRun, *this);
