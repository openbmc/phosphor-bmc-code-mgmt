...
I2CDevice::I2CDevice(sdbusplus::async::context& io, bool dryRun,
...
//NOLINTBEGIN
sdbusplus::async::task<bool> I2CDevice::startUpdateAsync()
//NOLINTEND
{
...
//NOLINTBEGIN
sdbusplus::async::task<bool> I2CDevice::deviceSpecificUpdateFunction(
...
//NOLINTBEGIN
sdbusplus::async::task<bool> I2CDevice::writeUpdate(
    sdbusplus::message::unix_fd image,
