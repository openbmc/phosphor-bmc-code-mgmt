...
{
	public:
		I2CDevice(sdbusplus::async::context& io, bool dryRun,
		...
		sdbusplus::async::task<boo> deviceSpecificUpdateFunction(
			sdbusplus::message::unix_fd image,
			std::shared_ptr<SoftwareActicationProgress> activationProgress) final;

	private:
		uint32_t bus;
		uint32_t address;

		sdbusplus::async::task<bool> writeI2C( 
			sdbusplus::message::unix_fd image, 
