...
{
    DeviceConfig config(0x0324, "com.example.SampleCorp",
...
TEST(DeviceConfig, failureObjPath)
{
    try
    {
        DeviceConfig config(0x0324, "com.example.samplecorp", "noslash");
        ASSERT_FALSE(true);
    }
    catch (std::exception& /*unused*/)
    {}
