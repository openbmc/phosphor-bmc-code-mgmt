...
sdbusplus::async::task<bool> MP2940X::updateFirmware(bool force)
{
    ...
    debug(
        ...
        "EXPUSER", lg2::hex, expectedCRCUser, "ACTUSER", lg2::hex,
        actualCRCUser, "EXPMULTI1", lg2::hex, expectedCRCMulti1, "ACTMULTI1",
        lg2::hex, actualCRCMulti1, "EXPMULTI2", lg2::hex, expectedCRCMulti2,
