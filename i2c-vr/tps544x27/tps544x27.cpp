...
constexpr uint8_t statusCmlInvalidCommandBit = 0x80;
constexpr uint8_t statusCmlInvalidDataBit = 0x40;
constexpr uint8_t statusCmlPecFailBit = 0x20;
constexpr uint8_t statusCmlMemoryFaultBit = 0x10;
constexpr uint8_t statusCmlOtherCommBit = 0x02;
constexpr uint8_t statusCmlErrorMask =
    statusCmlInvalidCommandBit | statusCmlInvalidDataBit | statusCmlPecFailBit |
    statusCmlMemoryFaultBit | statusCmlOtherCommBit;
