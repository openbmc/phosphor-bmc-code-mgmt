                                         ...
                                         uint16_t address)
{
    switch (vrType)
    {
        ...
        case VRType::MP2940X:
            return std::make_unique<MP2940X>(ctx, bus, address);
        case VRType::MP297X:
