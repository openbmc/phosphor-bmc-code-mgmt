...
// NOLINTEND(readability-static-accessed-through-instance)
{
    ...
    std::optional<bool> ret =
        co_await this->mfrFWcmd(MFRFwCmdGetCRC, tBuf, rBuf);
    if (!ret)
    {
...
// NOLINTEND(readability-static-accessed-through-instance)
{
    std::optional<bool> ret = co_await program(force);
    if (!ret)
    {
...
// NOLINTEND(readability-static-accessed-through-instance)
{
    std::optional<bool> ret = co_await mfrFWcmd(MFRFwCmdReset, NULL, NULL);
    if (!ret)
    {
