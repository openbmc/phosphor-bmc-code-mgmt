...
enum ERR {
    ...
    ERR_ctlRegs = -4,
    ERR_mfwFWcmd = -8,
    ERR_mfwFWcmd_DATA = -16,
    ERR_mfwFWcmd_CMD = -32,
    ERR_mfwFWcmd_Response = -64,
    ERR_getRemainingWrites = -128,
    ERR_getCRC = -256,
    ERR_program = -512,
    ERR_program_CRC_mismatch = -1024,
    ERR_program_remain = -2048,
};
...
class XDPE1X2XX : public VoltageRegulator
{
  public:
    ...
    int fwUpdate(const uint8_t* image, size_t image_size, bool force) final;
