...
RSA* Signature::createPublicRSA(const fs::path& publicKey)
{
    RSA* rsa = NULL;
    BIO* keyBio;
...
void* Signature::mapFile(const fs::path& path, size_t size)
{
...
void Signature::getFileContent(const fs::path& path,
