...
void ItemUpdater::createActivation(sdbusplus::message_t& msg)
{
    ...
    if (activations.find(versionId) == activations.end())
    {
        ...
        verifyAndCreateObjects(versionId, objectPath, version, purpose,
    ...
    ApplyTimeIntf::RequestedApplyTimes applyTime)
{
    ...
    activations.insert(std::make_pair(
        id, std::make_unique<Activation>(
                bus, path.str, *this, id,
                server::Activation::Activations::NotReady, associations)));
    ...
    std::vector<std::string>& compatibleNames)
{
    ...
    auto versionPtr = std::make_unique<VersionClass>(
        bus, path.str, version, purpose, extendedVersion, filePath,
        compatibleNames,
    ...
    {
        activations.insert(std::make_pair(
            id, std::make_unique<Activation>(bus, path.str, *this, id,
