...
// One NVIDIA Vera CPU recovered over USB RCM. Each entity-manager USBRCMFirmware
// config maps to one device (and one Software.Update object). A recovery
// package carries the CPU's firmware components; they are streamed to the RCM
// bootrom in package (RCM flash) order.
