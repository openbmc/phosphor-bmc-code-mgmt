...
void SPIDevice::getFt4222AdapterNum(const bool* devExist,
                                                     ...
                                                     size_t imageSize)
{
    ...
    std::vector<std::string> devSysPath = {
        lbbPCIeSwitchSysPath, rbbPCIeSwitchSysPath, amcPCIeSwitchSysPath};
