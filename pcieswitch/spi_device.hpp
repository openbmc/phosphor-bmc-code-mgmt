...
const std::string rbbPCIeSwitchSysPath =
    "/sys/bus/usb/devices/2-2.4.6/idProduct";
const std::string lbbPCIeSwitchSysPath =
    "/sys/bus/usb/devices/2-2.5.6/idProduct";
...
class SPIDevice : public Device
{
  public:
    ...
    static sdbusplus::async::task<bool> getVersion(std::string& version);
    void getFt4222AdapterNum(const bool* devExist, std::string& adapterNum);
