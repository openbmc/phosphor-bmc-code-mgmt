...
// NOLINTEND
{
    ...
    std::string objPathCurrentSoftware = device->currentSoftware->objectPath;
...
// NOLINTEND
{
    ...
    co_await device->currentSoftware->createInventoryAssociations(true);
...
// NOLINTEND
{
    ...
    co_await device->currentSoftware->createInventoryAssociations(false);
