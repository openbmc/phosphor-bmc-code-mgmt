...
class VoltageRegulator
{
  public:
    ...
    virtual int get_fw_full_version(char* ver_str) = 0;

    virtual int get_fw_active_key(char* key) = 0;

    virtual int get_fw_version(char* ver_str) = 0;

    virtual int fw_validate_file(const uint8_t* image_file,
                                 size_t image_size) = 0;
    virtual int fw_parse_file(const uint8_t* image,
                              size_t image_size) = 0;
    virtual int fw_update(bool force) = 0;
